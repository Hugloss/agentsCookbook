...
def main() -> None:
    ...
    outcomes = [
        Outcome(task_id="localized-python", treatment_id="p10", mode="baseline", correct=True, independent_qualification_activations=3, files_opened=12, evidence_bytes=20000, context_tokens_estimate=9000, tool_calls=20, repair_iterations=3, seconds_to_first_correct_edit=40.0, **common),
        Outcome(task_id="localized-python", treatment_id="p10", mode="bridge", correct=True, independent_qualification_activations=1, files_opened=5, evidence_bytes=8000, context_tokens_estimate=3500, tool_calls=9, local_commands=4, repair_iterations=1, seconds_to_first_correct_edit=18.0, bridge_elapsed_ms=120.0, local_independent_qualification_agree=True, **common),
        Outcome(task_id="broad-after-focused", treatment_id="p10", mode="baseline", correct=True, independent_qualification_activations=2, files_opened=10, evidence_bytes=15000, context_tokens_estimate=7000, tool_calls=16, repair_iterations=2, **common),
        Outcome(task_id="broad-after-focused", treatment_id="p10", mode="bridge", correct=True, independent_qualification_activations=1, files_opened=6, evidence_bytes=9000, context_tokens_estimate=4000, tool_calls=10, local_commands=5, repair_iterations=2, local_independent_qualification_agree=True, **common),
    ]
    ...
    assert result["promotion_evidence"]["local_independent_qualification_disagreement_zero"] is True
    ...
    unknown_qualification = compare([
        Outcome(task_id="unknown-qualification", treatment_id="p10", mode="baseline", correct=True, **common),
        Outcome(task_id="unknown-qualification", treatment_id="p10", mode="bridge", correct=True, local_independent_qualification_agree=None, **common),
    ])
    assert unknown_qualification["correctness"]["local_independent_qualification_unknown"] == 1
    assert unknown_qualification["promotion_evidence"]["local_independent_qualification_disagreement_zero"] is False


    bound_common = dict(common, bridge_implementation_id="bridge:v1", manifest_id="manifest:v1", local_qualification_id="local:v1", final_source_id="source:v1", independent_qualification_evidence_id="ci:v1", oracle_opened_after_freeze=True)
    strict_shared = dict(
    ...
    strict_baseline = Outcome(
        ...
        independent_qualification_evidence_id="ci:baseline", oracle_opened_after_freeze=True, **strict_shared,
    )
    strict_bridge = Outcome(
        ...
        final_source_id="source:bridge-final", independent_qualification_evidence_id="ci:bridge",
        local_independent_qualification_agree=True, oracle_opened_after_freeze=True, **strict_shared,
    )
    ...
    assert strict["promotion_evidence"]["local_independent_qualification_disagreement_zero"] is True
    ...
    _expect_error(lambda: compare([
        strict_baseline,
        Outcome(**{**strict_bridge.__dict__, "independent_qualification_evidence_id": None}),
    ], strict_dogfood=True))
    _expect_error(lambda: compare([
        strict_baseline,
        Outcome(**{**strict_bridge.__dict__, "independent_qualification_authority_id": None}),
    ], strict_dogfood=True))
    _expect_error(lambda: compare([
...
", encoding="utf-8")
    ...
    mismatch = Outcome(task_id="localized-python", treatment_id="p10", mode="bridge", correct=True, repository_id="other", task_fixture_id="fixture:v1", agent_profile="agent:v1", independent_qualification_authority_id="authority:repo")
